...
select
    cast(null as {{ datavault4dbt.string_default_dtype(type=none) }}) as Link_Name,
    cast(null as {{ datavault4dbt.string_default_dtype(type=none) }}) as Link_Hashkey,
    cast(null as {{ datavault4dbt.string_default_dtype(type=none) }}) as Foreign_Hashkeys,
    ...
    cast(null as {{ datavault4dbt.string_default_dtype(type=none) }}) as union_strategy,
